...
![ezgif com-gif-maker (1)](https://user-images.githubusercontent.com/49778407/177055019-32587ce3-a3ab-4339-8476-2814815636fc.gif)
...
I believe that not all of the topics helped. The first lab we did, Fast Feud, was more stressful and overwhelming than helpful because I had never used React before. I did feel unprepared and overwhelmed because the topic wasn't covered to the full extent. To make up for this I had to watch several videos on React which ate up the time I could've used to code.

- If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

If I had more time I wish I could've dove deeper into the CSS aspect of the lab.

- Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

_CHANGE AFTER FINISHING_
...
Shoutout to Beck, Nick, and Moe for being good teachers
